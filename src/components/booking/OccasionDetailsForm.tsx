        ...
        return (
          <div className="space-y-4">
            ...
            <input
              ...
              required
              className={inputClasses}
              onChange={(e) => onDetailsChange('weddingDate', e.target.value)}
            />
          </div>
        );
        ...
        return (
          <div className="space-y-4">
            ...
            <input
              ...
              required
              className={inputClasses}
              onChange={(e) => onDetailsChange('companyName', e.target.value)}
            />
            <input
              type="text"
              ...
              required
              className={inputClasses}
              onChange={(e) => onDetailsChange('yearsOfService', e.target.value)}
            />
          </div>
        );
        ...
        return (
          <div className="space-y-4">
            ...
            <input
              ...
              required
              className={inputClasses}
              onChange={(e) => onDetailsChange('recipientName', e.target.value)}
            />
            <textarea
              placeholder="Achievement"
              className={inputClasses}
              rows={3}
              onChange={(e) => onDetailsChange('achievement', e.target.value)}
            />
          </div>
        );
        ...
        return (
          <div className="space-y-4">
            ...
            <input
              ...
              required
              className={inputClasses}
              onChange={(e) => onDetailsChange('fatherName', e.target.value)}
            />
            <input
              type="text"
