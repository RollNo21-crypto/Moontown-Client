...
export default function ConfirmationModal({
  ...
  const handleShareToWhatsApp = () => {
    const adminWhatsApp = '919606993278';
    const message = `
🎫 New Booking Alert!
...
Total Price: ₹${totalPrice.toLocaleString()}
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-lg w-full p-6 relative max-h-[70vh] overflow-y-auto ">
        <button
          onClick={onClose}
        ...
        <div id="confirmation-content" className="bg-white p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-2">
              Your theater has been successfully booked
            </p>
          </div>
                ...
                {!bookingData.needs_package && (
                  <>
                    ...
                    <div className="font-medium">
                      ...
                      {bookingData.additional_options.fogEntry && (
                        <div>{bookingData.additional_options.fogEntry}</div>
                      )}
                      {bookingData.additional_options.photography && (
                        <div>Photography</div>
                      )}
